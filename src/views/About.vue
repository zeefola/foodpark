<template>
 <app-master>
    ...
    <div slot='breadCrumb'>
        <app-breadcrumb title="about"></app-breadcrumb>
    </div>
                            ...
                            <div class="product-slide-6 product-m no-arrow">
                                    ...
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/1.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a1.jpg" class="img-fluid  " alt="product">
                                            </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/2.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a2.jpg" class="img-fluid  " alt="product">
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/3.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a3.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="new-label3">
                                                <div>new</div>
                                            </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/4.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a4.jpg" class="img-fluid  " alt="product">
                                            </div>
                                        </div>
                                        <div class="product-detail detail-center ">
                                            <div class="detail-title">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/5.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a5.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="new-label3">
                                                <div>new</div>
                                            </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/6.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a5.jpg " class="img-fluid  " alt="product">
                                            </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/7.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a7.jpg" class="img-fluid  " alt="product">
                                            </div>
                                        </div>
                                        <div class="product-detail detail-center ">
                                            <div class="detail-title">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="/assets/images/layout-4/product/8.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="/assets/images/layout-4/product/a8.jpg" class="img-fluid  " alt="product">
                                            </div>
                                        </div>
                                        <div class="product-detail detail-center ">
                                            <div class="detail-title">
